...
class Refri_1 {
  ...
  //挿入
  static Future<void> insertMemo(Refri_1 refri_1) async {
  ...
  //取得
  static Future<List<Refri_1>> getMemos() async {
    ...
    List<Map<String, dynamic>> map2 = await db.query('refri_1');
  ...
  //更新
  static Future<void> updateMemo(Refri_1 refri_1) async {
  ...
  //日付順を取得
  static Future<List<Refri_1>> getMemosDates() async {
    /*var _now = DateTime.now();
    DateFormat outputFormat = DateFormat('yyyy-MM-dd-Hm');
    String nowDate = outputFormat.format(_now);*/
    final Database db = await database;
